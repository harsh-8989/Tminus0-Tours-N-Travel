    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ToursNTravels.flight')),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ToursNTravels.hotel')),
                ('train', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ToursNTravels.train')),
            ],
        ),
    ]
