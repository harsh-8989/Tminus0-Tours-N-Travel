    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destinationLocation', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='train_destination', to='ToursNTravels.location')),
                ('sourceLocation', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='train_source', to='ToursNTravels.location')),
            ],
        ),
        migrations.CreateModel(
            name='review',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numSeatsRemainingBusiness', models.IntegerField()),
                ('numSeatsRemainingFirst', models.IntegerField()),
                ('destinationLocation', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='flight_destination', to='ToursNTravels.location')),
                ('sourceLocation', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='flight_source', to='ToursNTravels.location')),
            ],
        ),
        migrations.AddField(
            model_name='booking',
